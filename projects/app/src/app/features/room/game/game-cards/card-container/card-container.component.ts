...
import { CardType, RoundState } from 'projects/app/src/app/core/models/enums';
import { Card, Deck, DynamicRoundData, RoomSettings, RoundInformation, StaticRoundData } from 'projects/app/src/app/core/models/interfaces';
