...
import { Card, RoomSettings, Round, TopicVotingCard } from "src/app/core/models/interfaces";
import { TopicVotingResponse } from "src/app/core/models/interfaces/logic/game-data/response-data/topic-voting-response";
